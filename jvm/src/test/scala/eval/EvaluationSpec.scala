...
class EvaluationSpec extends AnyFunSpec with Matchers with ExpressionTreeCodec {
  ...
  it("should interpret and evaluate tile comparison") {
     ...
     */
    val hillshadeTile =
      IntArrayTile(Array(0, 0, 0, 0, 0, 0, 2450, 2461, 2483, 0, 0, 2452, 2461, 2483, 0, 0, 2447, 2455, 2477, 0, 0, 0, 0, 0, 0), 5, 5)
    val hillshadeE =
      Extent(0, 0, 25, 25)
