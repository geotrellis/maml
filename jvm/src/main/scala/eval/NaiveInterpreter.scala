...
object NaiveInterpreter {
  ...
  def DEFAULT = NaiveInterpreter(
    List(
      ...
      SourceDirectives.scalarLiteral,
      SourceDirectives.boolLiteral,
      SourceDirectives.geomJson,
      OpDirectives.additionTile orElse OpDirectives.additionScalar,
      OpDirectives.subtraction,
      OpDirectives.multiplicationTile orElse OpDirectives.multiplicationScalar,
      OpDirectives.division,
      OpDirectives.pow,
      OpDirectives.maxTile orElse OpDirectives.maxScalar,
      OpDirectives.minTile orElse OpDirectives.minScalar,
